                        ...
                        <div class="col-xl-6 col-12">
                          <div class="row gx-2">
                            <div class="col-sm-4 col-6">
                              <div class="card px-3 py-2 mb-2 d-flex flex-row align-items-center">
                                <div class="position-relative shape-block">
                                  <img src="{{ asset('asset\assets/images/shape1.png') }}" class="img-fluid img-4x" alt="Bootstrap Themes" />
                            ...
                            <div class="col-sm-4 col-6">
                              <div class="card px-3 py-2 mb-2 d-flex flex-row align-items-center">
                                <div class="position-relative shape-block">
                                  <img src="{{ asset('assets\assets\images/shape2.png') }}" class="img-fluid img-4x" alt="Bootstrap Themes" />
                            ...
                            <div class="col-sm-4 col-6">
                              <div class="card px-3 py-2 mb-2 d-flex flex-row align-items-center">
                                <div class="position-relative shape-block">
                                  <img src="{{ asset('assets\assets/images/shape3.png') }}" class="img-fluid img-4x" alt="Bootstrap Themes" />
